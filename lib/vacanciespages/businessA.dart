...
class BusinessA extends StatefulWidget {
  const BusinessA({super.key});

  @override
  State<BusinessA> createState() => _BusinessAState();
}

class _BusinessAState extends State<BusinessA> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                      "Looking for a business analyst with excellect analitical skills  "),
                  Align(
                    alignment: Alignment.centerLeft,
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text(
                        "- Must be able to use and with with Microsoft Excel"),
                  ),
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text("- Monitoring and Analysing skills"),
                  ),
                  Align(
                    alignment: Alignment.centerLeft,
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text(
                        "- Knowledge of any programming languanges like Python , "),
                  ),
                  Align(
                    alignment: Alignment.centerLeft,
                    child:
